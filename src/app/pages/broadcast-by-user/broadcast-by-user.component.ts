...
@Component({
  selector: 'app-broadcast-by-user',
  templateUrl: './broadcast-by-user.component.html',
  styleUrls: ['./broadcast-by-user.component.scss']
})
export class BroadcastByUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.eventService.getEventsByUser(this.username)
      .subscribe(data => {
          this.events = data;
        },
        err => {
